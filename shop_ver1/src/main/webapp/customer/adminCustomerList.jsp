		...
		<table border = "1">
			...
			<tbody>
				...
				<tr>
					...
					<td><a href="<%=request.getContextPath()%>/admin/adminCustomerDeleteAction.jsp?customerId=<%=c.getCustomerId()%>">계정삭제</a></td>
					<td><a href="<%=request.getContextPath()%>/admin/adminCustomerPwUpdateAction.jsp?customerId=<%=c.getCustomerId()%>">비밀번호초기화</a></td>
				</tr>
				<%
					}
				%>
